            ...
            <table  class="table table-bordered table-hover" style="width:100% ">
                ...
                @csrf
                    ...
                    <tr>
                        ...
                        <th class="w-70">
                            <input name="phones" class="form-control" type="tel"  value="{{$data->phones}}">
                    ...
                    <tr>
                        ...
                        <th class="w-70">
                            <input name="address" class="form-control" type="tel"  value="{{$data->address}}">
                    ...
                    <tr>
                        ...
                        <th class="w-70">
                            <input name="email" class="form-control" type="tel"  value="{{$data->email}}">
                    ...
                    <tr>
                        ...
                        <th class="w-70">
                            <input name="after_minute_calculate_delay" class="form-control" type="tel"  value="{{$data->after_minute_calculate_delay}}">
                    ...
                    <tr>
                        ...
                        <th class="w-70">
                            <input name="after_minute_calculate_early_departure" class="form-control" type="tel"  value="{{$data->after_minute_calculate_early_departure}}">
                    ...
                    <tr>
                        ...
                        <th class="w-70">
                            <input name="after_minute_quarterday" class="form-control" type="tel"  value="{{$data->after_minute_quarterday}}">
                    ...
                    <tr>
                        ...
                        <th class="w-70">
                            <input name="after_time_half_daycut" class="form-control" type="tel"  value="{{$data->after_time_half_daycut}}">
                    ...
                    <tr>
                        ...
                        <th class="w-70">
                            <input name="after_time_allday_daycut" class="form-control" type="tel"  value="{{$data->after_time_allday_daycut}}">
                    ...
                    <tr>
                        ...
                        <th class="w-70">
                            <input name="mounthly_vacation_blance" class="form-control" type="tel"  value="{{$data->mounthly_vacation_blance}}">
                    ...
                    <tr>
                        ...
                        <th class="w-70">
                            <input name="after_days_begin_vacation" class="form-control" type="tel"  value="{{$data->after_days_begin_vacation}}">
                    ...
                    <tr>
                        ...
                        <th class="w-70">
                            <input name="first_balance_begin_vication" class="form-control" type="tel"  value="{{$data->first_balance_begin_vication}}">
                    ...
                    <tr>
                        <th class="w-30">بعد كم يوم ينزل للموضف رصيد اجازات </th>
                        <th class="w-70">
                            <input name="after_day_begin_vaction" class="form-control" type="tel"  value="{{$data->after_day_begin_vaction}}">
                    ...
                    <tr>
                        ...
                        <th class="w-70">
                            <input name="sanctions_value_first_abcence" class="form-control" type="tel"  value="{{$data->sanctions_value_first_abcence}}">
                    ...
                    <tr>
                        ...
                        <th class="w-70">
                            <input name="sanctions_value_second_abcence" class="form-control" type="tel"  value="{{$data->sanctions_value_second_abcence}}">
                    ...
                    <tr>
                        ...
                        <th class="w-70">
                            <input name="sanctions_value_thaird_abcence" class="form-control" type="tel"  value="{{$data->sanctions_value_thaird_abcence}}">
                    ...
                    <tr>
                        ...
                        <th class="w-70">
                            <input name="sanctions_value_fourth_abcence" class="form-control" type="tel"  value="{{$data->sanctions_value_fourth_abcence}}">
                    ...
                    <tr >
                        <th colspan="2" class="text-center">
                            <input  type="submit"  class="btn btn-success rounded-4 my-2 ms-auto" value=" تحديث اليبانات">
                        </th>
                    </tr>
                </form>
            </table>
